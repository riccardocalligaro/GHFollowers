...
class FavoritesListVC: UIViewController {
    ...
    let scrollView = UIScrollView()
       ...
       func setupViews(){
           ...
           greenView.topAnchor.constraint(equalTo: subtitleLabel.bottomAnchor).isActive = true
           ...
           greenView.widthAnchor.constraint(equalTo: contentView.widthAnchor).isActive = true
           greenView.heightAnchor.constraint(equalToConstant: 100).isActive = true
           //greenView.layoutMargins = UIEdgeInsets(top: 0, left:16, bottom: 32, right: 0)
